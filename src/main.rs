...
impl GameState for State {
    fn tick(&mut self, ctx: &mut BTerm) {
        ...
        //self.resources.get::<TYPE> requests a resource of a given type (in this case TurnState), from the ECS’s resources.
        //The final call to clone() duplicates the state.
        // This ensures that the resource is no longer borrowed;
        // you’re looking at a copy of the current turn state, rather than the original.
        // This is another example of working around Rust’s borrow checker.
